...
def test_proximal_fast_gm_prototype():
    ...
    method(oracle, x_0)
    method(oracle, x_0, L_0=1)
    check_prototype_results(method(oracle, x_0, tolerance=1e10, display=True),
                            [None, 'success', None])
    check_prototype_results(method(oracle, x_0, tolerance=1e10, trace=True, display=True),
                            [None, 'success', [0.0]])
    check_prototype_results(method(oracle, x_0, max_iter=1, display=True),
                            [None, 'iterations_exceeded', None])
    check_prototype_results(method(oracle, x_0, max_iter=1, trace=True, display=True),
                            [None, 'iterations_exceeded', [0.0, 0.0]])
    method(oracle, x_0, display=True)
    method(oracle, x_0, 1, 1e-5, 100, True, True)
...
def test_proximal_gm_nonsmooth():
    ...
    print('test_proximal_gm_nonsmooth', np.array(hist['func']))
...
def test_proximal_fast_gm_nonsmooth2():
    ...
    print('my value', x_star)
    print('my func', hist['func'])
